...
export default function Testimonials() {
  return (
    <section id="testimonials" className="mm-section" style={{ padding: '84px 0', borderTop: '1px solid var(--line)' }}>
      ...
      <div className="mm-3col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
